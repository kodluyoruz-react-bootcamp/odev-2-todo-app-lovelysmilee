...
function App() {
	...
	const addTodoItem = (item) => {
		...
		setTodoList([...todoList, { id: todoList.length > 0 ? todoList[todoList.length - 1].id + 1 : 1, todo: itemData, active: true }]);
	...
	return (
		<>
			<section className="todoapp">
				...
				<Main todoList={todoList} removeTodoItem={removeTodoItem} deactiveTodoItem={deactiveTodoItem} />
				<Footer todoLength={todoList.length} filterActive={filterActive} filterAll={filterAll} filterCompleted={filterCompleted} clearItems={clearItems}/>
			</section>
